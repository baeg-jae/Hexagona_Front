    ...
    return (
        <StWrapFlex>
            <StImgWrap>
                ...
                <div className="like">
                    <div className="likeImg" type="nth-of-type (z-index: n, left: 10px)"></div>
                </div>
            </StImgWrap>
            <StReplyWrap>
                ...
                <div className="reply">
                    ...
                    <div className="replyText">
                        저는 21살에 취업해서 1년씩 경력이 두군데 있고 지금은 2살에 1년 4개월정도 회사에 다니고 있습니다.
                        이직을 하고 싶은데 어떤 직종으로 가야할지 모르겠네요. 알려주시면 감사하겠습니다.
                    </div>
                </div>
            </StReplyWrap>
            <NavigatorBar />
