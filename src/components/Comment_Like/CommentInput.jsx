...
import { StInputDivGlobal, StWrap } from 'components/Common/GlobalStyles';
...
const CommentInput = ({ postId }) => {
    ...
    const bogusCheck = useCallback(() => {
        ...
        setDoubleClick(true);
        const foundSwears = badWordsComment.filter((word) => comment.toLowerCase().includes(word.toLowerCase()));
