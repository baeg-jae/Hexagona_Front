        ...
        >
            <SwiperSlide className="slider">
                ...
                <div className="smallSpanDiv">
                    ...
                    <span className="smallSpan">4가지의 갓생 카테고리를 준비했답니다.</span>
                </div>
            ...
            <SwiperSlide className="slider">
                ...
                <div className="smallSpanDiv">
                    <span className="smallSpan">갓생루틴을 완료하려면 인증이 필요해요.</span>
                    <span className="smallSpan">내가 오늘 하루 이룬 ‘갓생루틴'이 무엇인지</span>
            ...
            <SwiperSlide className="slider">
                ...
                <div className="smallSpanDiv">
                    <span className="smallSpan">다른 이들의 갓생 사진을 보고 좋아요를 눌러보세요!</span>
                    <span className="smallSpan">좋아요가 된다면 채팅까지도 할 수 있답니다.</span>
                </div>
                <div className="imgDiv">
                    <StImgDiv pic="four" />
